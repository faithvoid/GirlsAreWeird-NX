...
init -1 python hide:
    ...
    config.window_title = "Girls Are Weird"
    ...
    theme.roundrect(
        ...
        widget_selected = "#f4ffd5",

        ## The color of a disabled widget face. 
        disabled = "#37443d",

        ## The color of disabled widget text.
        disabled_text = "#f4ffd5",
    ...
    style.window.background = Frame("images/Box.png", 16, 16)
    ...
    style.mm_menu_frame.xpos = 0.77
    style.mm_menu_frame.xanchor = 0.5
    style.mm_menu_frame.ypos = 0.77
    ...
    style.default.font = "04B_03__.TTF"
    ...
    #http://www.renpy.org/wiki/renpy/doc/reference/functions/renpy.register_bmfont
    #info on how to make bitmap font for ren'py
...
python early:
    config.save_directory = "Girls Are Weird/Saves/"
